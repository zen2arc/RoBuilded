import { storage_get } from '../../modules/storage.js';
...
let clean_home = await storage_get("cleanhome");
console.log("CleanHome: " + clean_home);
if (clean_home) {
  xhook.after(function (request, response) {
    ...
    if (
      ...
      let decoded = JSON.parse(response.data);
